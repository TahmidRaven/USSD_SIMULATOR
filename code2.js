...
const submenus = {
  ...
  '*500#': {
    ...
    '2': {
      title: 'Data Usage',
      items: (account) => [
        `Used: ${account.dataUsage}`,
        'Remaining: 1.5 GB',
        'Valid until: 20 Nov 2025',
        '',
        'Press OK to go back'
      ]
    },
    '3': {
      title: 'Minute Balance',
      items: (account) => [
        `Minutes: ${account.minuteBalance}`,
        'Used this month: 93 mins',
    ...
    '4': {
      title: 'SMS Balance',
      items: (account) => [
        `SMS: ${account.smsBalance}`,
        'Used this month: 45 SMS',
        'Valid until: 25 Nov 2025',
        '',
        'Press OK to go back'
      ]
...
export default function USSDSimulator() {
  ...
  const handleKeyPress = (key) => {
    if (askingForAccount) {
      ...
      if (submenus[selectedCode] && submenus[selectedCode][key]) {
  ...
  const handleCall = () => {
    if (askingForAccount) {
      ...
      if (accounts[accountId]) {
        ...
        // Show main menu with account info
        const items = [
        ...
        setCurrentMenu({
          title: selectedCode === '*121#' ? 'Main Menu' : 'Balance & Usage',
          items: items
        });
      ...
      // In submenu, OK goes back
      handleOkPress();
    } else {
      // Initial call
      if (input === '*121#' || input === '*500#') {
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.sidebar}>
            ...
            <View style={styles.sidebarHeader}>
              <Text style={styles.sidebarTitle}>NOKIA Menu</Text>
            ...
            <ScrollView style={styles.sidebarContent}>
              ...
              <View style={styles.sidebarSection}>
                ...
                <View style={styles.accountCard}>
                  <Text style={styles.accountTitle}>Account 01 - Tahmid</Text>
              ...
              <View style={styles.sidebarSection}>
                ...
                <View style={styles.ussdCard}>
                  ...
                  <Text style={styles.ussdDesc}>Balance & Usage (requires account)</Text>
                </View>
                <View style={styles.ussdCard}>
                  <Text style={styles.ussdCode}>*999#</Text>
                  <Text style={styles.ussdDesc}>Mobile Banking</Text>
                </View>
                <View style={styles.ussdCard}>
              ...
              <View style={styles.sidebarFooter}>
                <Text style={styles.footerBrand}>NOKIA</Text>
                <Text style={styles.footerText}>Made by Tahmid Raven</Text>
          ...
          <View style={styles.screenInner}>
            {askingForAccount ? (
              ...
              <View style={styles.screenContent}>
                ...
                <Text style={styles.screenHint}>Try: *121# *500# *999#</Text>
              </View>
            ) : (
              <View style={styles.screenContent}>
